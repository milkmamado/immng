-- rnjsdmsthf@naver.com 매니저에게 시뮬레이션 환자 10명 추가
DO $$
DECLARE
  manager_id uuid;
...
BEGIN
  ...
  INSERT INTO public.patients (
    ...
    'P-2025-204', '정미경', '1975-05-30', '010-4567-8901',
    manager_id, '권은솔', '유입',
    '외래', '위암 조기 발견 후 관리 목적', '위암', '조기 위암 1기',
    '아산병원', '부드러운 음식',
    '윤한방', '서양방', '수술 후 회복 단계, 정기 검진 예정',
    'C-2025-204', random_date
  );
  ...
  INSERT INTO public.patients (
    ...
    'P-2025-206', '강수진', '1981-12-25', '010-6789-0123',
    manager_id, '권은솔', '유입',
    '외래', '난소암 진단 후 치료 방향 상담', '난소암', '난소암 2기',
    '고대안암병원', '일반식',
    '한한방', '안양방', '수술 예정, 사전 체력 증진 및 면역 관리',
    'C-2025-206', random_date
  );
